...
class AbstractRepositoryRestController2 implements MessageSourceAware {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractRepositoryRestController2.class);

    private final PagedResourcesAssembler<Object> pagedResourcesAssembler;
    private MessageSourceAccessor messageSourceAccessor;

    /**
     * Creates a new {@link AbstractRepositoryRestController2} for the given {@link PagedResourcesAssembler}.
     *
     * @param pagedResourcesAssembler must not be {@literal null}.
     */
    public AbstractRepositoryRestController2(PagedResourcesAssembler<Object> pagedResourcesAssembler) {
