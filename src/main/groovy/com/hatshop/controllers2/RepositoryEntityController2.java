 ...
 */
package com.hatshop.controllers2;
...
//@RequestMapping
class RepositoryEntityController2 extends AbstractRepositoryRestController2 implements ApplicationEventPublisherAware {

    private static final String BASE_MAPPING = "/json/{repository}";
    ...
    @Autowired
    public RepositoryEntityController2(Repositories repositories, RepositoryRestConfiguration config,
    ...
    public Iterable<?> getCollectionResource(final RootResourceInformation resourceInformation,
    ...
    @ResponseBody
    public Object getItemResource(RootResourceInformation resourceInformation,
    ...
    public ResponseEntity<? extends ResourceSupport> putItemResource(
        ...
        return invoker.invokeFindOne(id) == null
            ? createAndReturn(objectToSave, invoker, assembler)
            : saveAndReturn(objectToSave, invoker, PUT, assembler);
    }
